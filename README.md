## Porn Scenario Combinator (PornCombinator)

**PornCombinator** — это CLI-инструмент для анализа возможных комбинаций сексуальных сценариев и оценки совокупного возбуждающего эффекта. Он помогает порно-режиссёрам, сценаристам и энтузиастам находить потенциальные горячие связки между жанрами и приёмами на основе заданного элемента возбуждения.

---

### Возможности

* Поиск всех возможных комбинаций жанров и фетишей по базе `rules.json`
* Обратный поиск (где элемент используется в связке, а не как основной)
* Расчёт совокупного возбуждающего эффекта с учётом коэффициента возбуждения
* Экспорт результатов в файл для съёмочной группы или личного пользования
